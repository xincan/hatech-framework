 ...
 * @package cn.com.hatechframework.server.organization.dto
 * @className OrganizationInsertDTO
 * @description 机构添加DTO
 * @author WangMingShuai
 * @create 2019/12/27 19:17
 * @version 1.0
 * <author>                <time>                  <version>                   <description>
 * WangMingShuai         2019/12/27 19:17             1.0                         机构添加DTO
 */
@ApiModel(value = "cn.com.hatechframework.server.organization.dto.OrganizationInsertDTO", description = "机构添加DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
