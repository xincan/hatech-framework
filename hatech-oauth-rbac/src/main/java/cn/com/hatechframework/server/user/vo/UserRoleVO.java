...
public class UserRoleVO {
    ...
    @ApiModelProperty(value="角色名称", dataType = "String", example = "ADMIN角色")
    private String roleName;

    @ApiModelProperty(value="角色组名称", dataType = "String", example = "ADMIN组角色")
    private String roleGroupName;

    @ApiModelProperty(value="角色集合", dataType = "String", example = "[{}]")
    private List<RoleVO> roleList;

    @ApiModelProperty(value="角色组集合", dataType = "String", example = "[{}]")
