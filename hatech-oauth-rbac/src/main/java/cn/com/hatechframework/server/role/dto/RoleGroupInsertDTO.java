 ...
 * @package cn.com.hatechframework.server.role.dto
 * @className RoleGroupInsertDTO
 * @description 角色组添加DTO
 * @author WangMingShuai
 * @create 2019/12/27 14:57
 * @version 1.0
 * <author>                <time>                  <version>                   <description>
 * WangMingShuai         2019/12/27 14:57             1.0                         角色组添加DTO
 */
@ApiModel(value = "cn.com.hatechframework.server.role.dto.RoleGroupInsertDTO", description = "角色分页DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
