 ...
 * @package cn.com.hatechframework.server.operation.dto
 * @className OperationUpdateDTO
 * @description 修改操作按钮DTO
 * @author WangMingShuai
 * @create 2020/01/15 17:36
 * @version 1.0
 * <author>                <time>                  <version>                   <description>
 *  WangMingShuai          2020/01/15 17:36             1.0                         修改操作按钮DTO
 */
@ApiModel(value = "cn.com.hatechframework.server.operation.dto.OperationUpdateDTO", description = "修改操作按钮DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class OperationUpdateDTO {
	...
	@Size(message = "操作ID长度应小于{max}", max = 64)
	private String id;
