 ...
 * @package cn.com.hatechframework.entity.oauth.rbac.dto
 * @className UserTenantRegisterDTO
 * @description 租户注册DTO
 * @author WangMingShuai
 * @create 2019/12/28 15:07
 * @version 1.0
 * <Author>                <Time>                  <Version>                   <Description>
 * WangMingShuai         2019/12/28 15:07             1.0                         租户注册DTO
 */
@ApiModel(value = "cn.com.hatechframework.entity.oauth.rbac.dto.UserTenantRegisterDTO", description = "租户注册DTO")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class UserTenantRegisterDTO {
    ...
    @Length(message = "用户登录密码长度应该在{min}~{max}之间", min = 1, max = 11)
